  ...
  return (
    <div className='container my-8 mx-auto px-4 md:px-12'>
      <div className='flex justify-center mx-auto'>
        { profile?.avatar_url &&
          <img alt="content" className="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400" src={profile.avatar_url} />
        }
        <div className="flex flex-col items-center text-center justify-center">
          <h2 className="font-medium title-font mt-4 text-gray-900 text-lg">{ profile?.username }</h2>
